...
class Proccessor:
    ...
    def expression_evaluation(self, desiredDICT):     #general function for expressions
        transform = Transformer(self.list_expression)
    ...
    def expression_evaluation_math(self, desiredDICT):        #Later (function for expressions from module math and abs,round)  ['abs','-5'] => ['5']      
    ...
    def expression_evaluation_computemath(self):                          #Later abs(-2)+abs(-3) = 2 + 3    LATER
        ...
        while index != len(self.list_expression):                          
            if (self.list_expression[index] in DICT_MATH or                
                ...
                self.list_expression[index] in DICT_MATH_ARGS) and self.list_expression[index+1] == '(':
