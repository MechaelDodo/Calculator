...
class Transformer:
    ...
    def math_transformation(self):      #['a', 'b', 's', '(', '2', '-', '10', ')'] => ['abs', '(', '2', '-', '10', ')']
        firstoffset = 0
        secondoffset = 0
        self.list_expression.append('')                 #QUICK'N'DIRTY      
        while True:
            checkvalue = ''.join(self.list_expression[firstoffset:secondoffset])
            if (checkvalue in DICT_MATH_ARGS or
                ...
                if checkvalue + self.list_expression[secondoffset] != 'atan2':
                    ...
                    checkvalue = checkvalue + self.list_expression[secondoffset]
